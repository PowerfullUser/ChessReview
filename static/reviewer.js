...
if (!pgn) {
    ...
    ;
    function loadWhiteDetails() {
        const whiteUsernameElement = document.querySelector(".white-username");
        const whiteUsername = sessionStorage.getItem("white-username");
        const whiteRatingElement = document.querySelector(".white-rating");
    ...
    ;
    function loadBlackDetails() {
        const blackUserElement = document.querySelector(".black-username");
        const blackUsername = sessionStorage.getItem("black-username");
        const blackRatingElement = document.querySelector(".black-rating");
    ...
    try {
        ...
        function moveList(history) {
            const whiteMovesElement = document.querySelector(".white-moves");
            const blackMovesElement = document.querySelector(".black-moves");
        ...
        const stockfish = new Worker("/static/stockfish.js");
        let evalHistory = [];
        let percentages = [];
        let whiteAccuracies = [];
        let blackAccuracies = [];
        ...
        function displayAverage(white, black) {
            const whiteElement = document.getElementById("white-accuracy");
            const blackElement = document.getElementById("black-accuracy");
        ...
        function displayFeedback(json) {
            const white_greatElement = document.getElementById("great-white");
            const white_excellentElement = document.getElementById("excellent-white");
            const white_goodElement = document.getElementById("good-white");
            const white_inaccurateElement = document.getElementById("inaccurate-white");
            const white_mistakeElement = document.getElementById("mistake-white");
            const white_blunderElement = document.getElementById("blunder-white");
            const black_greatElement = document.getElementById("great-black");
            const black_excellentElement = document.getElementById("excellent-black");
            const black_goodElement = document.getElementById("good-black");
            const black_inaccurateElement = document.getElementById("inaccurate-black");
            const black_mistakeElement = document.getElementById("mistake-black");
            const black_blunderElement = document.getElementById("blunder-black");
            if (json) {
